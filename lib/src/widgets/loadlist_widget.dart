...
void initState() { 
  ...
  Widget build(BuildContext context) {
    return  Container(
      margin: EdgeInsets.only(left:15.0,right:15.0),
            ...
            itemBuilder: (context,int index){
              return listItem(loads[index].status,loads[index].shippers[0].location,loads[index].shippers[0].time,loads[index].shippers[1].location,loads[index].shippers[1].time,loads[index].id,context);
            },
    ...
    Widget listItem(var status, var pickup, var pickuptime, var delivery, var deliverytime,id,context){
      if(status == 'canceled'){
        return Text('');
      }
      return InkWell(
          ...
          Flexible(
            ...
            Flexible(
              ...
              child: Container(
                margin: EdgeInsets.only(left: 10.0),
                width: double.infinity,
                child: Text('${pickup.city} ${pickup.county} , ${pickup.state} ${pickup.zipcode}',
                           style: TextStyle(
          ...
          Flexible(
            ...
            Flexible(
              ...
              child: Container(
                margin: EdgeInsets.only(left: 10.0),
                width: double.infinity,
                child: Text('${delivery.city} ${delivery.county} , ${delivery.state} ${delivery.zipcode}',
                           style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 16.0,  
                                                ),)
