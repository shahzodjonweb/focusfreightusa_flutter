...
class _ReportState extends State<Report> {
               ...
               child:Row(
                 children: [
                   ...
                   Flexible(
                     ...
                     child: Container(
                       width: double.infinity,
                       child: Text("Select The Report Type",   style: TextStyle(
  ...
  Widget showReportData(var name, Color color,int number){
    return new Material(
      ...
      // player.play('sound1.mp3');
        ...
        switch (number) {
          case 1: _colorContainer1=Color(0xFFcfd3d8);message=name;pressed=true;
          if(pressedNumber==number){
            _colorContainer1=Color(0xFFE7EBF0);pressedNumber=0;pressed=false;
          }else{pressedNumber=number;}
          break;

          case 2: _colorContainer2=Color(0xFFcfd3d8);message=name;pressed=true;
          if(pressedNumber==number){
            _colorContainer2=Color(0xFFE7EBF0);pressedNumber=0;pressed=false;
          }else{pressedNumber=number;}
          break;
          
          case 3: _colorContainer3=Color(0xFFcfd3d8);message=name;pressed=true;
          if(pressedNumber==number){
            _colorContainer3=Color(0xFFE7EBF0);pressedNumber=0;pressed=false;
          }else{pressedNumber=number;}
          break;

          case 4: _colorContainer4=Color(0xFFcfd3d8);message=name;pressed=true;
          if(pressedNumber==number){
            _colorContainer4=Color(0xFFE7EBF0);pressedNumber=0;pressed=false;
          }else{pressedNumber=number;}
          break;
          default:
        }
  ...
  var token = key;
   final result = await post('http://sbuy.uz/api/load/send_report', 
   body: json.encode({
     'loadid': loadid,
     'message': message
     }),
